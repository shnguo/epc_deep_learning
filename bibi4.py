...
if __name__=='__main__':
    ...
    # full_text_array = af_textlist(full_text_array)
    ...
    # train_y = train_y[:10]
    # t_x = t_x[:10]
    model.fit(train_x, train_y, batch_size=16, epochs=4)
    # model = get_hd5_model()
    ...
    da = DataFrame(idlist)
    da[1] = classes
    da.to_csv('result6.csv',sep=',', encoding='utf-8',index=False,header=False)
